...
class Aluno(models.Model):
    ...
    motivo_desligamento = models.CharField(max_length=300, blank=True, null=True)
...
class Atividade(models.Model):
    ...
    data_funcionamento = models.ForeignKey('DatasFuncionamento', models.DO_NOTHING, db_column='data_funcionamento')
...
class DisciplinaPreRequisitos(models.Model):
    id_disciplina = models.ForeignKey(Disciplina, models.DO_NOTHING, db_column='id_disciplina', primary_key=True)
    id_disciplina_pre_requisito = models.ForeignKey(Disciplina, models.DO_NOTHING, db_column='id_disciplina_pre_requisito')
...
class Falta(models.Model):
    ...
    id_turma_aluno = models.ForeignKey('TurmaAlunos', models.DO_NOTHING, db_column='id_turma_aluno')
    data_funcionamento = models.ForeignKey(DatasFuncionamento, models.DO_NOTHING, db_column='data_funcionamento')
    ...
    class Meta:
        managed = False
        db_table = 'falta'
        unique_together = (('id_falta', 'id_turma_aluno', 'data_funcionamento'),)
...
class NotaAluno(models.Model):
    ...
    id_turma_aluno = models.ForeignKey('TurmaAlunos', models.DO_NOTHING, db_column='id_turma_aluno')
    id_atividades_turma = models.ForeignKey('TurmaAtividades', models.DO_NOTHING, db_column='id_atividades_turma')
    valor_nota = models.FloatField()

    class Meta:
        managed = False
        db_table = 'nota_aluno'
        unique_together = (('id_nota', 'id_turma_aluno', 'id_atividades_turma'),)
...
class PagamentoAlimentos(models.Model):
    id_pagamento = models.ForeignKey(Pagamento, models.DO_NOTHING, db_column='id_pagamento', primary_key=True)
...
class TurmaAlunos(models.Model):
    ...
    id_pagamento = models.ForeignKey(Pagamento, models.DO_NOTHING, db_column='id_pagamento')
...
class UsuarioPermissoes(models.Model):
    ...
    id_voluntario = models.ForeignKey(Usuario, models.DO_NOTHING, db_column='id_voluntario')
    id_usuario_permissao = models.ForeignKey(Permissao, models.DO_NOTHING, db_column='id_usuario_permissao')

    class Meta:
        managed = False
        db_table = 'usuario_permissoes'
        unique_together = (('id_usuario', 'id_voluntario', 'id_usuario_permissao'),)
...
class Voluntario(models.Model):
    ...
    funcao_informatica = models.CharField(max_length=100, blank=True, null=True)
...
class VoluntarioDisciplinas(models.Model):
    id_voluntario = models.ForeignKey(Voluntario, models.DO_NOTHING, db_column='id_voluntario', primary_key=True)
    id_disciplina = models.ForeignKey(Disciplina, models.DO_NOTHING, db_column='id_disciplina')
